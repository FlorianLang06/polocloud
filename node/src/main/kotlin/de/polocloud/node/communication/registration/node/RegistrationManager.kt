...
class RegistrationManager(
    ...
    fun tryJoinCluster(registrationInfo: RegistrationInfo, localId : UUID, group: String) {
        ...
        val response = client.tryRegister(registrationInfo.address,registrationInfo.token, holder.value.general.bindAddress.hostname, holder.value.general.bindAddress.port, localId, group, csr)
