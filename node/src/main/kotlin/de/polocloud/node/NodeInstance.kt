...
class NodeInstance(
    ...
    init {
        ...
        this.registrationManager =
            RegistrationManager(configurations.clusterConfig, nodeRepository, certificateDataStorage.keyPair)
    ...
    fun initialize() {
        ...
        if (nodeRepository.count() == 0L) {
            ...
            this.localNodeContainer =
                LocalNodeContainer(nodeRepository, NodeFactory.createInitial(resolveBindAddress()))
