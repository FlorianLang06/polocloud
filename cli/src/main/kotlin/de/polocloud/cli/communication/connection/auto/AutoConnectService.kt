package de.polocloud.cli.communication.connection.auto
...
import de.polocloud.cli.communication.connection.lifecycle.ConnectionLifecycle
...
class AutoConnectService(
    ...
    private var eventListener: ShutdownEventListener? = null
    ...
    fun attachListener() {
        eventListener = ShutdownEventListener(connectionManager).also { listener ->
            listener.start {
                connectionManager.disconnect()
